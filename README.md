...
* Demonstrate the use of Generative AI.
...
* **Python**
* **Streamlit**
* **Generative AI / Image Generation Model**
* **Git & GitHub**
* **VS Code**
...
3. The prompt is sent to the image generation model.
4. The AI generates an image based on the prompt.
...
warm sunlight coming through the window, cozy study room,
realistic style.
```
